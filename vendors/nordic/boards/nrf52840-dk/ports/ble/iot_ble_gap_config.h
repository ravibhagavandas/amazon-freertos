...
#define aws_ble_gap_configMIN_CONN_INTERVAL                 0x20 /**< Minimum acceptable connection interval (0.5 seconds). */
#define aws_ble_gap_configMAX_CONN_INTERVAL                 0x40 /**< Maximum acceptable connection interval (1 second). */
